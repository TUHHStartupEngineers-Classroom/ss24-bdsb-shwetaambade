...
# Convert prices to numeric and scale down by 100 to get the correct format
bike_price <- as.numeric(bike_price) / 100

# Format prices with two decimal places and add the euro symbol
bike_price <- sprintf(fmt = "%.2f €", bike_price)


# Merging the two tables into one
da2 <- tibble(bike_model, bike_price)

# Remove trailing zeros and convert to numeric if needed
...
# Print the bike model and bike price for inspection
bike_model
bike_price
